...
const Nav = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 z-50 w-full bg-[#f8f5ee] shadow-sm">
      <div className="flex h-15 md:h-20 w-full items-center justify-between px-4 sm:px-6 md:px-8 lg:px-12 xl:px-11">
        <div className="text-xl font-bold text-[#173126] sm:text-2xl">
          <a href="#home">ApexGym</a>
        </div>

        <div className="hidden md:block">
          <ul className="flex items-center gap-5 text-sm lg:gap-7">
            <li className="cursor-pointer"><a href="#programme">Programme</a></li>
            <li className="cursor-pointer"><a href="#about">About</a></li>
            <li className="cursor-pointer"><a href="#membership">Membership</a></li>
            <li className="cursor-pointer"><a href="#schedule">Schedule</a></li>
